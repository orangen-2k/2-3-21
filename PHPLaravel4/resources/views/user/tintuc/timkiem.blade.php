                                                                        ...
                                                                        <div class="content-top-in">
                                                                            <div class="entry-meta clearfix">
                                                                                <div class="meta-entry entry-date pull-left">
                                                                                    ...
                                                                                    <span class="month-time"><a href="#">December 16, 2016</a></span>
                                                                                </div>

                                                                                <div class="meta-entry entry-category pull-left">
                                                                                    <i class="fa fa-folder-open"></i>Categories : <a href="blog_left_sidebar.html" rel="category">Blog</a>
                                                                                </div>
                                                                            </div>
                                                                            <div class="entry-title">
                                                                                <h4><a href="{{route('detail.home',['id'=>$item->id,'tinkhongdau'=>$item->tieudekhongdau])}}">{{$item->loaitin->theloai->ten}}</a></h4>
                                                                                <div>
                                                                                    <div class="col-md-10">
